...
\hypersetup{unicode=true,
            pdftitle={NBA Constitution and By-Laws - 2019},
            pdfauthor={Robert},
            pdfborder={0 0 0},
            breaklinks=true}
...
\item
  ...
  \item
    ``Suspended List'' shall mean the list of those Players who, for proper cause, have been suspended by the Association or by the Member having the right to so suspend, and have therefore been removed from the Active, Inactive, or Two-Way Lists of their Teams.
  \item
  ...
  \item
    ``Two-Way Contract'' shall mean a player contract between a Player and a Member that provides for a tiered salary based on whether the Player is performing services on a particular day for (i) an NBA G League team, or (ii) an NBA Team, in accordance with the NBA/NBPA Collective Bargaining Agreement then in effect.
  \item
    ``Two-Way List'' shall mean the list of Players who have signed Two-Way Contracts with a Member and are eligible to provide services to a team in the NBA G League, in accordance with Section 6.04 of the By-Laws and the NBA/NBPA Collective Bargaining Agreement then in effect.
  \item
    ``Two-Way Player'' means a Player under a Two-Way Contract in accordance with the NBA/NBPA Collective Bargaining Agreement then in effect.
  \item
    ``Voluntarily Retired List'' shall mean the list of those Players who have formally retired as players in the Association.
  \item
    ``Writing'' or ``Written Notice'' shall mean any written communication delivered personally or sent by certified mail (return receipt requested), facsimile, internationally recognized overnight courier service, or electronic mail system utilized by the Association.
  \end{enumerate}
\item
  All references to ``Articles'' or ``Sections'' shall be references to the Articles and Sections of the Constitution and By-Laws, as they may be amended, modified, supplemented, or restated from time to time.
\item
...
\item
  Any violation of the provisions of this Article 5 shall constitute a violation of Article 13(b).
\end{enumerate}
